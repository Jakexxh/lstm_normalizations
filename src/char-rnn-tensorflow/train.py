...
def main():
    ...
    parser.add_argument(
        '--save_dir',
        type=str,
        default='/tmp/log/char/save',
        help='directory to store checkpointed models')
    parser.add_argument(
        '--log_dir',
        type=str,
        default='/tmp/log/char/logs',
    ...
    parser.add_argument(
        '--seq_length', type=int, default=50, help='RNN sequence length')
    parser.add_argument(
...
def train(args):
    ...
    with tf.Session() as sess:
        ...
        for e in range(args.num_epochs):
            sess.run(
                tf.assign(model.lr, args.lr * (args.decay_rate**e)))
            ...
            for b in range(data_loader.num_batches):
                ...
                summ, train_loss, state, _ = sess.run(
                    [summaries, model.cost, model.final_state,
                     model.train_op], feed)
                ...
                print(
                    ...
                    .format(e * data_loader.num_batches + b, args.num_epochs *
                            data_loader.num_batches, e, train_loss, end -
                            start))
