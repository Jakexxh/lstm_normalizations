...
python ptb_word_lm.py --lr=1.0 --rnn_mode=bn_sep --num_gpus=1 --save_path=/tmp/log/ptb_ref_basae/bn_sep_g0.1_1.0

python ptb_word_lm.py --lr=1.0 --rnn_mode=pcc_sep --num_gpus= --save_path=/tmp/log/ptb_ref_base/pcc_sep_g1.0_1.0
