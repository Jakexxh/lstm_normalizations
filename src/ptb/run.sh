...
#
#python ptb_word_lm.py --lr=1.0 --g=0.1 --rnn_mode=pcc_sep --num_gpus=1 --save_path=/tmp/log/ptb_ref_new
#python ptb_word_lm.py --lr=1.0 --g=1.0 --rnn_mode=pcc_sep --num_gpus=1 --save_path=/tmp/log/ptb_ref_new
#python ptb_word_lm.py --lr=1.0 --g=10.0 --rnn_mode=pcc_sep --num_gpus=1 --save_path=/tmp/log/ptb_ref_new
...
#python ptb_word_lm.py --lr=1.0 --g=0.01 --rnn_mode=wn_sep --num_gpus=1 --save_path=/tmp/log/ptb_ref_new
#python ptb_word_lm.py --lr=1.0 --g=0.1 --rnn_mode=wn_sep --num_gpus=1 --save_path=/tmp/log/ptb_ref_new
#python ptb_word_lm.py --lr=1.0 --g=1.0 --rnn_mode=wn_sep --num_gpus=1 --save_path=/tmp/log/ptb_ref_new
#
