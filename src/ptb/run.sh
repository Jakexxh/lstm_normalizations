...
python ptb_word_lm.py --lr=1.0 --rnn_mode=basic --num_gpus=0 --save_path=/tmp/log/ptb_ref/basic_1.0

python ptb_word_lm.py --lr=1.0 --rnn_mode=cn_sep --num_gpus=0 --save_path=/tmp/log/ptb_ref/cn_sep_g1.0_1.0

python ptb_word_lm.py --lr=1.0 --rnn_mode=wn_sep --num_gpus=0 --save_path=/tmp/log/ptb_ref/wn_sep_g1.0_1.0

python ptb_word_lm.py --lr=1.0 --rnn_mode=ln_sep --num_gpus=0 --save_path=/tmp/log/ptb_ref/ln_sep_g0.1_1.0

python ptb_word_lm.py --lr=1.0 --rnn_mode=bn_sep --num_gpus=0 --save_path=/tmp/log/ptb_ref/bn_sep_g0.1_1.0

python ptb_word_lm.py --lr=1.0 --rnn_mode=pcc_sep --num_gpus=0 --save_path=/tmp/log/ptb_ref/pcc_sep_g1.0_1.0
