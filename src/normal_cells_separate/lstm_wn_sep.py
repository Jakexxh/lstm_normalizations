...
class WNLSTMCell(RNNCell):
    ...
    def _line_sep(self,
        ...
        with vs.variable_scope(scope) as outer_scope:
            ...
            wn_ih = self.weight_norm(h, W_ih, 'wn_ih') + wn_xh[:, :h_size]
            wn_jh = self.weight_norm(h, W_jh, 'wn_jh') + wn_xh[:, h_size:h_size * 2]
            wn_fh = self.weight_norm(h, W_fh, 'wn_fh') + wn_xh[:, h_size * 2:h_size * 3]
            wn_oh = self.weight_norm(h, W_oh, 'wn_oh') + wn_xh[:, h_size * 3:]
